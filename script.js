const academicData = {
  duke: {
    ...
    breaks: [
      ...
      { start: "2025-10-11", end: "2025-10-14", name: "Fall Break", type: "break" },
      { start: "2025-11-26", end: "2025-11-30", name: "Thanksgiving Recess", type: "break" },
      { start: "2025-12-16", end: "2026-01-06", name: "Winter Break", type: "break" },
      { start: "2026-01-19", end: "2026-01-19", name: "Martin Luther King Jr. Day", type: "holiday" },
      { start: "2026-03-07", end: "2026-03-15", name: "Spring Recess", type: "break" },
      { start: "2026-05-03", end: "2026-05-03", name: "First Day of Summer Break", type: "holiday" },
    ],
  },
  gsu: {
    ...
    breaks: [
      ...
      { start: "2025-12-17", end: "2026-01-11", name: "Winter Break", type: "break" },
      { start: "2026-01-19", end: "2026-01-19", name: "Martin Luther King Jr. Day", type: "holiday" },
      { start: "2026-03-16", end: "2026-03-22", name: "Spring Break", type: "break" },
      { start: "2026-05-06", end: "2026-05-06", name: "First Day of Summer Break", type: "holiday" },
    ],
  },
  uga: {
    ...
    breaks: [
      { start: "2025-09-01", end: "2025-09-01", name: "Labor Day", type: "holiday" },
      { start: "2025-10-31", end: "2025-10-31", name: "Fall Break", type: "holiday" },
      { start: "2025-11-26", end: "2025-11-30", name: "Thanksgiving Break", type: "break" },
      { start: "2025-12-11", end: "2026-01-11", name: "Winter Break", type: "break" },
      { start: "2026-01-19", end: "2026-01-19", name: "Martin Luther King Jr. Day", type: "holiday" },
      { start: "2026-03-07", end: "2026-03-15", name: "Spring Break", type: "break" },
      { start: "2026-05-06", end: "2026-05-06", name: "First Day of Summer Break", type: "holiday" },
    ],
  },
  yale: {
    ...
    breaks: [
      { start: "2025-09-01", end: "2025-09-01", name: "Labor Day", type: "holiday" },
      { start: "2025-10-15", end: "2025-10-19", name: "October Recess", type: "break" },
      { start: "2025-11-22", end: "2025-11-30", name: "November Recess", type: "break" },
      { start: "2025-12-18", end: "2026-01-11", name: "Winter Recess", type: "break" },
      { start: "2026-01-19", end: "2026-01-19", name: "Martin Luther King Jr. Day", type: "holiday" },
      { start: "2026-03-07", end: "2026-03-22", name: "Spring Recess", type: "break" },
      { start: "2026-05-07", end: "2026-05-07", name: "First Day of Summer Break", type: "holiday" },
    ],
  },
  gatech: {
    ...
    breaks: [
      { start: "2025-09-01", end: "2025-09-01", name: "Labor Day", type: "holiday" },
      { start: "2025-10-04", end: "2025-10-07", name: "Fall Break", type: "break" },
      { start: "2025-11-26", end: "2025-11-30", name: "Thanksgiving Break", type: "break" },
      { start: "2025-12-12", end: "2026-01-11", name: "Winter Break", type: "break" },
      { start: "2026-01-19", end: "2026-01-19", name: "Martin Luther King Jr. Day", type: "holiday" },
      { start: "2026-03-21", end: "2026-03-29", name: "Spring Break", type: "break" },
      { start: "2026-05-08", end: "2026-05-08", name: "First Day of Summer Break", type: "holiday" },
    ],
  },
  rutgers: {
    ...
    breaks: [
      ...
      { start: "2026-01-05", end: "2026-01-19", name: "Winter Intersession", type: "break" },
      { start: "2026-03-14", end: "2026-03-22", name: "Spring Recess", type: "break" },
      { start: "2026-05-04", end: "2026-08-31", name: "First Day of Summer Break", type: "holiday" },
    ],
  },
  northeastern: {
